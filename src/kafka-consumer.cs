...
namespace KafkaConsumer
{
    public class Program
    {
        ...
        /// </summary>
        public static void Run_Consume(string groupId, string brokerList, List<string> topics, CancellationToken cancellationToken)
        {
        ...
        public static void Main(string[] args)
        {
            ...
            var group = args.Any() ? args[0] : "csharp-consumer";
            var mode = "consume"; // args[0];
            var brokerList = "localhost:9092"; // args[1];
            var topics = new List<string> { "best-topic" }; // args.Skip(2).ToList();
            ...
            {
                case "consume":
                    Run_Consume(group, brokerList, topics, cts.Token);
                    break;
                case "manual":
